...
<li class="list-group-item">
	<div class="media">
		...
		<div class="media-body">
			<a class="btn btn-outline btn-primary btn-squared pull-xs-right" href="{$v.downloadurl}" title="{$v.title}"  target="{$lang.met_listurlblank}">{$lang.download}</a>
			<h4 class="media-heading font-size-16">
				<a class="name" href="{$v.url}"  target="{$lang.met_listurlblank}" title="{$v.title}">{$v._title}</a>
			</h4>
