            ...
            <div class="met-showimg-body col-md-9" m-id='noset'>
                ...
                <div class="detail_tag font-size-14">
                    ...
                    <list data="$data[taglist]" name="$tag">
                        <a href="{$tag.url}" title="{$tag.name}" target="{$lang.met_listurlblank}">{$tag.name}</a>
                    </list>
                </div>
                </if>
                    ...
                    <div class="met-bar">
                        ...
                        <if value="$lang['img_bar_list_open']">
                            <div class="sidebar-news-list recommend">
                                ...
                                <?php $id=$ui['id']?$ui['id']:$data['class1']; ?>
                                    <tag action='list' cid="$data['classnow']" num="$lang['img_bar_list_num']" type="$lang['img_bar_list_type']">
                                    <li class="list-group-item">
                                    <a class="imga" href="{$v.url}" title="{$v.title}" {$g.urlnew}>
                                        <img src="{$v.imgurl}" alt="{$v.title}" style="max-width: 100%;">
                                    </a>
