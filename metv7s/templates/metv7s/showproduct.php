                                ...
                                <div class='sidebar-piclist'>
                                    ...
                                    <if value="$lang['product_sidebar_content']">
                                        ...
                                        <li class='masonry-child'>
                                            <a href='{$v.url}' title='{$v.title}' class='block m-b-0' target="{$lang.met_listurlblank}">
                                                <img data-original="{$v.imgurl|thumb:$v['img_x'],$v['img_y']}" class='cover-image' alt='{$v.title}' height='100'></a>
                                            <h4 class='m-t-10 m-b-0 font-size-14'>
                                                <a href='{$v.url}' title='{$v.title}' target="{$lang.met_listurlblank}"><if value="$v['_title']">{$v._title}<else/>{$v.title}</if></a>
                                            </h4>
                                        </li>
                                        </tag>
                                    <else/>
